      ...
      const eventsData = [
        {
          ...
          venue: v1._id,
          venueDetails: { name: v1.name, address: v1.address, city: v1.city, state: v1.state },
        ...
        },
        {
          ...
          organizer: organizer1._id,
          venue: v2._id,
          venueDetails: { name: v2.name, address: v2.address, city: v2.city, state: v2.state },
        ...
        },
        {
          ...
          organizer: organizer1._id,
          venue: v3._id,
          venueDetails: { name: v3.name, address: v3.address, city: v3.city, state: v3.state },
