    ...
    const rawEvents = [
      {
        ...
        venue: venues[0]._id,
        venueDetails: { name: venues[0].name, address: venues[0].address, city: venues[0].city },
      ...
      },
      {
        ...
        organizer: organizer1._id,
        venue: venues[1]._id,
        venueDetails: { name: venues[1].name, address: venues[1].address, city: venues[1].city },
      ...
      },
      {
        ...
        venue: venues[3]._id,
        venueDetails: { name: venues[3].name, address: venues[3].address, city: venues[3].city },
      ...
      },
      {
        ...
        organizer: organizer2._id,
        venue: venues[2]._id,
        venueDetails: { name: venues[2].name, address: venues[2].address, city: venues[2].city },
      ...
      },
      {
        ...
        organizer: organizer1._id,
        venue: venues[4]._id,
        venueDetails: { name: venues[4].name, address: venues[4].address, city: venues[4].city },
